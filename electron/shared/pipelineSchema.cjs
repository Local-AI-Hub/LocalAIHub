...
const PIPELINE_NODE_TYPES = Object.freeze({
  ...
  mediaComposition: Object.freeze({
    ...
    configDefaults: {
      ...
      soundEffectsGlobalMinSpacingSeconds: DEFAULT_MEDIA_COMPOSITION_GLOBAL_SOUND_EFFECTS_MIN_SPACING_SECONDS,
      soundEffectsGlobalMaxSimultaneous: DEFAULT_MEDIA_COMPOSITION_GLOBAL_SOUND_EFFECTS_MAX_SIMULTANEOUS,
    },
  }),
