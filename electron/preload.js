...
contextBridge.exposeInMainWorld('localAIHub', {
  ...
  createHyperFramesProject: (payload) => invoke('hyperframes-projects:create', payload),
  createHyperFramesProjectFile: (payload) => invoke('hyperframes-projects:create-file', payload),
  deleteAssetLibrary: (payload) => invoke('asset-libraries:delete', payload),
  deleteHyperFramesProject: (payload) => invoke('hyperframes-projects:delete', payload),
  deleteHyperFramesProjectAsset: (payload) => invoke('hyperframes-projects:delete-asset', payload),
  deleteHyperFramesProjectFile: (payload) => invoke('hyperframes-projects:delete-file', payload),
  ...
  renameHyperFramesProject: (payload) => invoke('hyperframes-projects:rename', payload),
  duplicateHyperFramesProject: (payload) => invoke('hyperframes-projects:duplicate', payload),
  duplicateHyperFramesProjectAsset: (payload) => invoke('hyperframes-projects:duplicate-asset', payload),
  duplicateHyperFramesProjectFile: (payload) => invoke('hyperframes-projects:duplicate-file', payload),
  ...
  listHyperFramesProjectAssets: (payload) => invoke('hyperframes-projects:list-assets', payload),
  listHyperFramesProjectFiles: (payload) => invoke('hyperframes-projects:list-files', payload),
  listHyperFramesProjects: () => invoke('hyperframes-projects:list'),
  listHyperFramesProjectTemplates: () => invoke('hyperframes-projects:templates'),
  ...
  openHyperFramesProjectFolder: (payload) => invoke('hyperframes-projects:open-folder', payload),
  openHyperFramesStudio: (payload) => invoke('hyperframes-studio:open', payload),
  ...
  pickHyperFramesProjectAssets: (payload) => invoke('hyperframes-projects:pick-assets', payload),
  prepareHyperFramesProjectPipeline: (payload) => invoke('hyperframes-projects:prepare-pipeline', payload),
  readHyperFramesProjectFile: (payload) => invoke('hyperframes-projects:read-file', payload),
  renameHyperFramesProjectAsset: (payload) => invoke('hyperframes-projects:rename-asset', payload),
  renameHyperFramesProjectFile: (payload) => invoke('hyperframes-projects:rename-file', payload),
  saveHyperFramesProjectFile: (payload) => invoke('hyperframes-projects:save-file', payload),
  ...
  stopHyperFramesStudio: (payload) => invoke('hyperframes-studio:stop', payload),
